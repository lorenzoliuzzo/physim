...
class FunctionSum : public FunctionBase {
    ...
    public:
        ...
        std::vector<FunctionBase> m_functions; 
        double m_c; 

        FunctionSum(const FunctionBase& f, const FunctionBase& g, const double& c = 0) : m_c{c} { 
        ...
        double eval(const double& x) const override {
            return m_c + m_functions[0].eval(x) + m_functions[1].eval(x); 
        }

        void print_equation() const override {
            std::cout << "Sum of equation:\n"; 
            m_functions[0].print_equation(); 
            m_functions[1].print_equation(); 
...
struct Square : public FunctionBase {
...
struct Cube : public FunctionBase {
...
struct SquareRoot : public FunctionBase {
...
struct Logarithm : public FunctionBase {
...
struct Sine : public FunctionBase {
...
struct Cosine : public FunctionBase {
