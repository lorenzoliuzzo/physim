...
class Particle : public Position {
    ...
    public:  
        ...
        Particle(double mass, double charge, std::vector<double> coord, std::vector<double> vel) : 
            m_mass{mass}, m_charge{charge},
            Position(coord, vel) {}

        Particle(double mass, double charge, Position pos) : 
...
class Electron : public Particle {
    ...
    public:  
        ...
        Electron(std::vector<double> coord, std::vector<double> vel) : 
            Particle(e_mass, e_charge, coord, vel) {}

        Electron(Position pos) : 
            Particle(e_mass, e_charge, pos) {}
...
class Proton : public Particle {
    ...
    public:  
        ...
        Proton(std::vector<double> coord, 
                std::vector<double> vel) : 
            Particle(p_mass, p_charge, coord, vel) {}

        Proton(Position pos) : 
            Particle(p_mass, p_charge, pos) {}
