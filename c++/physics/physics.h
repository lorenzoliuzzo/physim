...
namespace physics {
        ...
        namespace measurements {
            ...
            class measurement : public measure, public units::unit {
                ...
                public:
                    ...
                    measurement(const double& value, const double& error, const int& __base, const char* __prefix = "") : measure(value, error), units::unit(__base, __prefix) {}
        ...
        namespace position {
            ...
            class coordinates : public tools::units::unit {
                ...
                protected: 
                    ...
                    std::vector<double> m_coordinates = algebra::vector_algebra::zeros(3);
    ...
    namespace objects {
        ...
        using namespace algebra::vector_algebra;
        ...
        class field { 
            ...
            public:
                ...
                std::vector<double> m_attraction = zeros(3);           
                ...
                // virtual std::vector<double> attraction(const position::coordinates& coord) = 0; 
        ...
        class mass : public measurement, public field {
            ...
            public: 
                ...
                mass(const double& value, const double& error = 0., const int& __prefix = 6) : measurement(value, error, 0, __prefix) {}
                
                mass(const double& value, const double& error = 0., const char* __prefix = "") : measurement(value, error, 0, __prefix) {}
                ...
                // virtual std::vector<double> attraction(const position::coordinates& coord) override {
                //     if (m_field == false) {
                //         std::cout << "Before evaluating the gravitational attraction, you must activate the gravitational field." << std::endl; 
                //         exit(-11);
                //     }
                //     return algebra::vector_algebra::zeros(3);
                //     // else if (coord == get_coordinates()) { return algebra::vector_algebra::zeros(3); }
                //     // else { return get_direction(coord) * (- G * get_value() / pow(get_distance(coord), 2)); }
                // }
